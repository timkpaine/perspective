...
import { View } from "@perspective-dev/perspective";

// import type * as perspective from "@perspective-dev/perspective";
...
export interface IPerspectiveViewerPlugin {
     ...
     * `@perspective-dev/perspective-viewer-datagrid`), doing so currently has nearly
     ...
     * reload.  For example, `@perspective-dev/perspective-viewer-d3fc` uses
